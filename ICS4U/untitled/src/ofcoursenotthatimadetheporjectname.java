...
public class ofcoursenotthatimadetheporjectname {
    public static void main(String[] args) {
        ...
        //adds all th inputs together-FILLER
        int total6 =  num1+num2+num3;

        //subtracts the inputs together, and makes the difference negative-FILLER
    ...
    //function for the sum-the second int is the sum for the imputed numbers
